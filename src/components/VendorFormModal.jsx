...
const vendorValidation = [
  {
    name: "name",
    rules: [
      (value) => (!value ? "Vendor name is required" : null),
...
export function VendorFormModal({ isOpen, onClose, onSubmit, initialData, isLoading }) {
  const { formData, setValue, reset, errors, validate, touched } = useForm(
    initialData || { name: "", email: "", phone: "", address: "", city: "", state: "", zip: "", country: "" }
  );
